...
$dbuild -t 083388942401.dkr.ecr.us-west-2.amazonaws.com/sentry-self-hosted-jq --platform="$DOCKER_PLATFORM" jq

jq="docker run --rm -i 083388942401.dkr.ecr.us-west-2.amazonaws.com/sentry-self-hosted-jq"
